...
const FilaCargaScreen = ({ navigation, route }) => {
  ...
  const [filaCargaData, setFilaCargaData] = useState([]);
  ...
  const fetchFilaCargaData = async () => {
    try {
      ...
      if (data.dados?.listaFilaCarga?.filaCargaVeiculos) {
        const filaCargaData = data.dados.listaFilaCarga.filaCargaVeiculos;
        setFilaCargaData(filaCargaData);
  ...
  const renderFilaCargaItem = ({ item }) => (
    <View style={styles.filaCard}>
      <View style={styles.cardHeader}>
        <Text style={styles.filaText}>Fila {item.fc_fila}</Text>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{formatPeso(item.fc_peso || 0)}</Text>
        </View>
  ...
  const renderHeader = () => (
    <View>
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={styles.summaryDivider} />
        <View style={styles.summaryItem}>
          <Text style={styles.summaryValue}>{filaCargaData.length}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Lista de Filas de Carga com resumo no header */}
      {loading && filaCargaData.length === 0 ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Nenhuma fila de carga ativa</Text>
