...
const PatioCargaScreen = ({ navigation, route }) => {
  ...
  const fetchPatioCargaData = useCallback(async () => {
    try {
      ...
      if (
        ...
        updateState("patioCargaData", patioCargaData);
  ...
  const renderPatioCargaItem = ({ item }) => (
    <View style={styles.patioCard}>
      <View style={styles.cardHeader}>
        <Text style={styles.filaText}>{item.pc_grupo || "Não informado"}</Text>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{formatPeso(item.pc_peso)}</Text>
        </View>
      </View>
    </View>
  );
  ...
  const renderHeader = () => (
    <View>
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={styles.summaryDivider} />
        <View style={styles.summaryItem}>
          <Text style={styles.summaryValue}>{state.patioCargaData.length}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {state.loading && state.patioCargaData.length === 0 ? (
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>
                {state.errorMessage || "Nenhum veículo no pátio de carga"}
              </Text>
