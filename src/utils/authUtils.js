 ...
 */
export const validateAndSanitizeCredentials = (username, password) => {
  // Validar comprimento
 ...
 */
export const validateLoginResponse = (response, responseText) => {
 ...
 */
export const extractToken = (response, responseText) => {
